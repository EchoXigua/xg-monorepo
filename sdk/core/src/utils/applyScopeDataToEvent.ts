import type { Breadcrumb, Event, ScopeData, Span } from '@xigua-monitor/types';
import { arrayify, dropUndefinedKeys } from '@xigua-monitor/utils';
...
function applyFingerprintToEvent(
  event: Event,
  fingerprint: ScopeData['fingerprint'] | undefined,
): void {

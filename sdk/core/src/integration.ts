...
declare module '@xigua-monitor/types' {
...
export function setupIntegration(
  ...
  if (typeof integration.preprocessEvent === 'function') {
    const callback = integration.preprocessEvent.bind(
      integration,
    ) as typeof integration.preprocessEvent;
  ...
  if (typeof integration.processEvent === 'function') {
    const callback = integration.processEvent.bind(
      integration,
    ) as typeof integration.processEvent;

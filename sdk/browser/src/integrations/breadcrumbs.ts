...
const _breadcrumbsIntegration = ((
  options: Partial<BreadcrumbsOptions> = {},
) => {
  const _options = {
    console: true,
    dom: true,
...
export const breadcrumbsIntegration = defineIntegration(
 ...
 */
function _getSentryBreadcrumbHandler(
  client: Client,
): (event: SentryEvent) => void {
...
function _getConsoleBreadcrumbHandler(
  client: Client,
): (handlerData: HandlerDataConsole) => void {
 ...
 */
function _getXhrBreadcrumbHandler(
  client: Client,
): (handlerData: HandlerDataXhr) => void {
 ...
 */
function _getFetchBreadcrumbHandler(
  client: Client,
 ...
 */
function _getHistoryBreadcrumbHandler(
  client: Client,
): (handlerData: HandlerDataHistory) => void {

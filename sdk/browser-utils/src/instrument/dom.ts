import type { HandlerDataDom } from '@xigua-monitor/types';
 ...
 * @hidden
 */
export function addClickKeypressInstrumentationHandler(
...
function isSimilarToLastCapturedEvent(event: Event): boolean {
  ...
  try {
    ...
    if (
      !event.target ||
      (event.target as SentryWrappedTarget)._sentryId !==
 ...
 */
function shouldSkipDOMEvent(
  eventType: string,
  target: SentryWrappedTarget | null,
): boolean {

import { addBreadcrumb, captureException } from '@xigua-monitor/core';
import type { ConsoleLevel, SeverityLevel } from '@xigua-monitor/types';
import { logger as coreLogger } from '@xigua-monitor/utils';
